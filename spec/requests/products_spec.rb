...
RSpec.describe "Products", type: :request do
  ...
  let(:update_product_service) { UseCases::Product::UpdateProductService }
  ...
  describe "#initialize" do
    ...
    it "initializes UpdateProductService" do
      expect(subject.instance_variable_get(:@update_service)).to be_a(update_product_service)
    end

    it "initializes DestroyProductService" do
  ...
  describe "#update" do
    ...
    context "with invalid attributes" do
      before do
        patch product_path(product.id), params: invalid_attributes
      end
    ...
    context "with valid attributes" do
      before do
        patch product_path(product.id), params: valid_attributes
      end
