...
class ErrorHighlight::Spotter
  ...
  #
  # source://error_highlight//error_highlight/base.rb#79
  def initialize(node, point_type: T.unsafe(nil), name: T.unsafe(nil)); end

  # source://error_highlight//error_highlight/base.rb#104
  def spot; end

  private

  # source://error_highlight//error_highlight/base.rb#538
  ...
  #     ^^^^^
  #
  # source://error_highlight//error_highlight/base.rb#316
  ...
  #    ^^^^^^
  #
  # source://error_highlight//error_highlight/base.rb#290
  ...
  #        ^
  #
  # source://error_highlight//error_highlight/base.rb#275
  ...
  #     ^
  #
  # source://error_highlight//error_highlight/base.rb#231
  ...
  #      ^^^^^
  #
  # source://error_highlight//error_highlight/base.rb#494
  def spot_colon2; end
  ...
  #       ^^
  #
  # source://error_highlight//error_highlight/base.rb#386
  ...
  #   ^^^
  #
  # source://error_highlight//error_highlight/base.rb#372
  ...
  #     ^^^^^^^^
  #
  # source://error_highlight//error_highlight/base.rb#439
  ...
  #    ^^^^^^ (for []=)
  #
  # source://error_highlight//error_highlight/base.rb#414
  ...
  #            ^^
  #
  # source://error_highlight//error_highlight/base.rb#482
  ...
  #    ^^^^^^^ (for foo=)
  #
  # source://error_highlight//error_highlight/base.rb#461
  ...
  #      ^^^^^^^^
  #
  # source://error_highlight//error_highlight/base.rb#512
  ...
  #       ^
  #
  # source://error_highlight//error_highlight/base.rb#357
  ...
  #   ^
  #
  # source://error_highlight//error_highlight/base.rb#336
  ...
  #   ^^^
  #
  # source://error_highlight//error_highlight/base.rb#399
  def spot_vcall; end
end

# source://error_highlight//error_highlight/base.rb#101
