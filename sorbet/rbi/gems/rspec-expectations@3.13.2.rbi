...
class RSpec::Matchers::BuiltIn::Include < ::RSpec::Matchers::BuiltIn::BaseMatcher
  ...
  # @return [Boolean]
  #
  # source://rspec-expectations//lib/rspec/matchers/built_in/include.rb#210
  ...
  # @api private
  #
  # source://rspec-expectations//lib/rspec/matchers/built_in/include.rb#184
  def count_enumerable(expected_item); end

  # @api private
  #
  # source://rspec-expectations//lib/rspec/matchers/built_in/include.rb#189
  def count_inclusions; end

  # @api private
  # @return [Boolean]
  #
  # source://rspec-expectations//lib/rspec/matchers/built_in/include.rb#201
