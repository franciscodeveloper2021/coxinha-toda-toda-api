...
class Product
  ...
  module GeneratedAssociationMethods
    ...
    sig { params(value: T.nilable(::Sector)).void }
    def sector=(value); end
  end
  ...
  module GeneratedAttributeMethods
    ...
    def saved_change_to_sector_id; end
    ...
    def sector_id=(value); end

    sig { returns(T::Boolean) }
    def sector_id?; end

    sig { returns(T.nilable(::Integer)) }
    def sector_id_before_last_save; end

    sig { returns(T.untyped) }
    def sector_id_before_type_cast; end

    sig { returns(T::Boolean) }
    def sector_id_came_from_user?; end

    sig { returns(T.nilable([T.nilable(::Integer), T.nilable(::Integer)])) }
    def sector_id_change; end

    sig { returns(T.nilable([T.nilable(::Integer), T.nilable(::Integer)])) }
    def sector_id_change_to_be_saved; end

    sig { params(from: T.nilable(::Integer), to: T.nilable(::Integer)).returns(T::Boolean) }
    def sector_id_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(::Integer)) }
    def sector_id_in_database; end

    sig { returns(T.nilable([T.nilable(::Integer), T.nilable(::Integer)])) }
    def sector_id_previous_change; end

    sig { params(from: T.nilable(::Integer), to: T.nilable(::Integer)).returns(T::Boolean) }
    def sector_id_previously_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(::Integer)) }
    def sector_id_previously_was; end

    sig { returns(T.nilable(::Integer)) }
    def sector_id_was; end

    sig { void }
    def sector_id_will_change!; end
    ...
    sig { returns(T::Boolean) }
    def will_save_change_to_sector_id?; end
